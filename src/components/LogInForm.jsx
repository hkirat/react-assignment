...
<>
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form className='space-y-6' action='#' method='POST'>
        ...
        <h2 className='mt-4 text-center font-bold text-2xl tracking-tight leading-6 text-gray-900' >Sign into your account</h2>
         ...
         <div>
          ...
          <button type = "submit" className='flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold leading-6 text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-indigo-600 '>Sign In</button>
