...
export default function SignUp() {
    ...
    <div className='text-slate-300 font-mono sm:text-3xl lg:text-3xl xl:text-4xl font-bold my-24 justify-center max-w-fit mx-auto'>Hey, New Here, let's SignUp</div>

            < div className=" border-slate-600 border-solid border-4 w-fit h-50  mx-auto  space-x-4 space-y-4 bg-slate-950/75 shadow-2xl pr-28 p-8 rounded-xl">

                <div className='flex flex-row p-12'>

                    <div className='basis-1/2 flex flex-col w-80 space-y-4'>
                        <label htmlFor='name' className=' text-slate-500 font-mono'>Full Name</label>
                        ...
                        <label htmlFor='confPass' className='text-slate-500 font-mono '>Confirm Password</label>
                    </div>
                <div className='basis-1/2 w-8 space-y-4 flex flex-col'>
                    ...
                    <input type= 'password'name='confPass' className='text-sky-600 bg-slate-500/50 focus:ring-sky-500 focus:ring-2 focus:outline-none  focus:shadow-2xl focus:bg-slate-600/50 rounded-md px-2 w-60 font-extrabold text-md'></input>
                </div>
