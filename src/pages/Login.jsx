...
export default function Login() {
    ...
    return (
        <div className='bg-slate-800 h-screen w-screen'>
            <nav className='flex flex-row justify-start place-items-center text-sm sm:text-md  w-full h-8 transition ease-in-out duration-300 bg-slate-900/40 hover:bg-slate-900/25 shadow-2xl shadow-sky-400/75 space-x-6 sm:space-x-14 md:space-x-16 lg:space-x-20'>
            ...
            <div className='text-slate-300 font-mono text-2xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold my-24 justify-center max-w-fit mx-16 sm:mx-36 md:mx-56 lg:mx-64'>Hey, Welcome Back, let's Login</div>
    ...
    <div div className=" border-slate-600 border-solid border-4 w-fit h-50  mx-auto  space-x-4 space-y-4 bg-slate-950/75 shadow-2xl pr-28 p-8 rounded-xl">
        ...
        <div className='flex flex-row p-12 space-x-4 '>
            <div className='basis-1/2 flex flex-col w-18 sm:w-36 md:w-48 lg:w-64 space-y-4'>
            ...
            <div className='basis-1/2 w-10 sm:w-36 md:w-48 lg:w-64 space-y-4 flex flex-col '>
