...
const Signup = () => {
  return (
    <>
      <Header />
      <div className="w-full max-w-md p-8 space-y-10 rounded-xl bg-gray-50 text-gray-800 mx-auto">
        ...
        <div className="flex items-center pt-4 space-x-1">
          ...
          <p className="px-3 text-sm text-gray-600">Sign up social accounts</p>
          <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
        </div>
